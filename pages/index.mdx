...
Path to check for is: /view-vercel

LINK: https://portfolio1-jramanar.vercel.app/view-vercel gets redirected to the Vercel home page. 
 
 ## Redirect Assist
 Q: A customer writes in to the Helpdesk asking "How do I do a redirect from /hello-vercel to https://vercel.com?" In a couple of paragraphs, how do you respond?
...
Q: A customer writes in to the Helpdesk stating "I have a custom domain which I purchased at GoDaddy and I want to use it on my project". In a couple of
